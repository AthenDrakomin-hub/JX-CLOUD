...
console.log('3. 运行: supabase link --project-ref zlbemopcgjohrnyyiwvs');
console.log('4. 运行: supabase functions deploy api --project-ref zlbemopcgjohrnyyiwvs');
console.log('');
console.log('🌐 部署后访问地址:');
console.log('   https://zlbemopcgjohrnyyiwvs.supabase.co/functions/v1/api');
console.log('');
