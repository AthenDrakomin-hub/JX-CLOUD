...
export const translations = {
  zh: {
    ...
    // 注册审批
    registration_pending_title: '等待管理员审核',
    registration_pending_message: '您的注册申请已提交，管理员将在24小时内完成审核',
    registration_email_sent: '审核结果将发送至 {email}',
    back_to_login: '返回登录',
    ...
    success: '成功', error: '错误',
    new_order_toast: '新订单: {room}', sync_active: '已同步', sync_offline: '离线'
  },
  en: {
    ...
    registration_pending_title: 'Awaiting Admin Approval',
    registration_pending_message: 'Your registration request has been submitted. Admin will review within 24 hours',
    registration_email_sent: 'Approval result will be sent to {email}',
